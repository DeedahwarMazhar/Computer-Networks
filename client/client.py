...
if os.path.exists(path):
    ...
    if file_size == os.stat(path).st_size - pointer or file_size - 1 == os.stat(path).st_size - pointer or file_size - 2 == os.stat(path).st_size - pointer or file_size - 3 == os.stat(path).st_size - pointer:
